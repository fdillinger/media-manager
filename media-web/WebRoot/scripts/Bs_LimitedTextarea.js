...
this.infolineCssClass;this.infolineCssStyle;this.numberCssClass;this.numberCssStyle;this._elementId  = elementId;this._element    = document.getElementById(elementId);this._maxLength = maxLength;this.useProgressBar = false;this._lastNumProgressBars
